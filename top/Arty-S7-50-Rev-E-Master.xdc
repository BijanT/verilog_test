...
## Switches
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { i_sw }]; #IO_L20N_T3_A19_15 Sch=sw[0]
...
## LEDs
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { o_led }]; #IO_L16N_T2_A27_15 Sch=led[2]
